...
const Pricing = () => {
  return <section id='membership'>
    ...
    <div className="pricing__top">
        ...
        <p>Healthify is a popular nutrition and exercise tracking app that offers a premium subscription service.<br/>The premium version includes advanced nutrient tracking, customized goals and advice, and exclusive content.</p>
    </div>
